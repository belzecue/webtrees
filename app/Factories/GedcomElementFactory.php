 ...
 */
class GedcomElementFactory implements GedcomElementFactoryInterface
{
    /** @var array<string,GedcomElementInterface> */
    private $elements;

    /**
     * GedcomElementFactory constructor.
     */
    public function __construct()
    {
        ...
        $this->elements = [
            ...
            'INDI:_BRTM'               => new UnknownElement(I18N::translate('Brit milah')), // *** webtrees
            'INDI:_BRTM:DATE'          => new DateValue(I18N::translate('Date of brit milah')), // *** webtrees
            'INDI:_BRTM:PLAC'          => new PlaceName(I18N::translate('Place of brit milah')), // *** webtrees
            ...
            'NOTE'                => new EmptyElement(I18N::translate('Note')),
            'NOTE:CONC'           => new SubmitterText(I18N::translate('Concatenation')),
            ...
            'REPO'                => new EmptyElement(I18N::translate('Repository')),
            ...
            'SOUR'                => new EmptyElement(I18N::translate('Source')),
            'SOUR:DATA'           => new SourceData(I18N::translate('Data')),
            ...
            'SUBM'                => new EmptyElement(I18N::translate('Submitter')),
